...
CREATE POLICY "Admins can manage invoices" ON public.invoices TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: rooms Admins can manage rooms; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can manage rooms" ON public.rooms TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: rooms Anyone can view available rooms; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can view available rooms" ON public.rooms FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Users can update their own bookings" ON public.bookings FOR UPDATE TO authenticated USING (((auth.uid() = user_id) OR public.has_role(auth.uid(), 'admin'::public.app_role)));
...
CREATE POLICY "Users can view their own bookings" ON public.bookings FOR SELECT TO authenticated USING (((auth.uid() = user_id) OR public.has_role(auth.uid(), 'admin'::public.app_role)));
...
CREATE POLICY "Users can view their own invoices" ON public.invoices FOR SELECT TO authenticated USING (((auth.uid() = user_id) OR public.has_role(auth.uid(), 'admin'::public.app_role)));
